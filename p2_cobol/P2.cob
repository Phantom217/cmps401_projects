       ...
       01 VARIABLES.
           ...
           02 SemesterName     PIC X(11).
           02 SubjectID        PIC X(10).
           02 SubjectName      PIC X(30).
           02 SubjectPTS       PIC 99.
           02 SubjectCredit    PIC 99.
           02 s_SubjectCredit  PIC ZZ.99.
           02 SubjectGrade     PIC X(1).
           02 obtainedGrade    PIC 99.
           02 SemesterGrade    PIC 99.
           02 s_SemesterGrade  PIC ZZ.99.
           02 SemesterToalHour PIC 9(1).99.
           02 SemesterGPA      PIC 9(1).99.
           02 CommulativeGpa   PIC 9(1).99.
           02 SemesterCredit   PIC 99.
           02 s_SemesterCredit PIC ZZ.99.
           02 TotalHours       PIC 99.
           02 s_TotalHours     PIC ZZ.99.
           02 QtPoints         PIC ZZ.99.
           02 QualityPoints    PIC 999.
           02 s_QualityPoints  PIC ZZZ.99.
      ...
      *>   PERFORM 003-WriteNameandWnumber.
      ...
      *>   PERFORM 004-DISPLAYSEMESTERHEADING.
       ...
       002-WRITEHEADING.
           MOVE " " TO DatFile
           STRING LargeSpace,LargeSpace,LargeSpace,LargeSpace,
            LargeSpace,LargeSpace,LargeSpace,
            "SOUTHEASTERN LOUISIANA UNIVERSITY" INTO DatFile
           WRITE OutDatFile
           MOVE " " TO DatFile
           STRING LargeSpace,LargeSpace,LargeSpace,LargeSpace,
             LargeSpace,LargeSpace,LargeSpace,LargeSpace,LargeSpace,
             "HAMMOND, LA, 70402",x'0a' INTO DatFile
           WRITE OutDatFile
               ...
               ELSE
                   IF RunningLine = "$$"
                       ...
                       IF FirstSem ="N"
                           ...
                           MOVE SemesterCredit TO s_SemesterCredit
                           MOVE SemesterGrade TO s_SemesterGrade
                           DISPLAY LargeSpace,LargeSpace,LargeSpace,LargeSpace,LargeSpace,LargeSpace,LargeSpace,"SEMESTER", LargeSpace,LargeSpace,LargeSpace,"     ", s_SemesterCredit, LargeSpace," ",s_SemesterGrade,LargeSpace,SemesterGPA
                           STRING LargeSpace,LargeSpace,LargeSpace,LargeSpace,LargeSpace,LargeSpace,LargeSpace,"SEMESTER", LargeSpace,LargeSpace,LargeSpace,"     ", s_SemesterCredit, LargeSpace," ",s_SemesterGrade,LargeSpace,SemesterGPA INTO  OutDatFile
                           WRITE OutDatFile
                           MOVE " " TO DatFile
                           MOVE TotalHours TO s_TotalHours
                           MOVE QualityPoints TO s_QualityPoints
                           DISPLAY LargeSpace,LargeSpace,LargeSpace,LargeSpace,LargeSpace,LargeSpace,LargeSpace,"CUMULATIVE", LargeSpace,LargeSpace,LargeSpace,"   ", s_TotalHours, LargeSpace,s_QualityPoints,LargeSpace,CommulativeGpa
                           STRING LargeSpace,LargeSpace,LargeSpace,LargeSpace,LargeSpace,LargeSpace,LargeSpace,"CUMULATIVE", LargeSpace,LargeSpace,LargeSpace,"   ", s_TotalHours, LargeSpace,s_QualityPoints,LargeSpace,CommulativeGpa INTO OutDatFile
                           WRITE OutDatFile
                           MOVE " " TO DatFile
                   ...
                   ELSE
                       ...
                       ELSE
                           ...
                           ELSE
                               ...
                               MOVE obtainedGrade TO QtPoints
                               MOVE SubjectCredit TO s_SubjectCredit
                               DISPLAY SubjectID,LargeSpace,SubjectName," "SubjectGrade,LargeSpace,"   ",s_SubjectCredit,LargeSpace," ",QtPoints
                               STRING SubjectID,LargeSpace,SubjectName,"  ",SubjectGrade,LargeSpace,"  ",s_SubjectCredit,LargeSpace," ",QtPoints INTO OutDatFile
